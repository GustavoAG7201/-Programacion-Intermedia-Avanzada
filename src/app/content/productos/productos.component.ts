...
export class ProductosComponent {
    ...
    productos = [
      ...
      {imagen: '/imagenes/producto2.png', descripcion: 'Diseño moderno, con suela de goma que garantiza tracción, perfectas para un estilo deportivo y diario ', precio: '$2,500 MXN', tallas: 'Tallas: 6,7,8,9,10,11'},
      ...
      {imagen: '/imagenes/producto4.png', descripcion: 'Diseño ultra vibrante, su parte superior es suave y detalles llamativos contrastando con el logotipo azul', precio: '$3,000 MXN', tallas: 'Tallas: 6,7,8,9,10,11'},
